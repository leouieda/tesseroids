...
"""
TessGx:
    Calculate the X component of the gravity field of a tesseroid model.
"""
################################################################################
...
if __name__ == '__main__':
    ...
    name = 'TessGx'
    description = "  Calculates the X component of gravity generated by a " + \
                  "tesseroid model."

    main = Main(name, description, sys.argv, tg.TesseroidGx, version='0.1')
    main.start()
    sys.exit()
