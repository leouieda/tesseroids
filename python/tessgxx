...
"""
TessGxx:
    Calculate the XX component of the gravity gradient tensor field of a
    tesseroid model.
"""
################################################################################
...
if __name__ == '__main__':
    ...
    name = 'TessGxx'
    description = "  Calculates the XX component of the gravity gradient " + \
                  "tensor generated by a tesseroid model."

    main = Main(name, description, sys.argv, tg.TesseroidGxx, version='0.1')
    main.start()
    sys.exit()
