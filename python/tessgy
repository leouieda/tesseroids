...
"""
TessGy:
    Calculate the Y component of the gravity field of a tesseroid model.
"""
################################################################################
...
if __name__ == '__main__':
    ...
    name = 'TessGy'
    description = "  Calculates the Y component of gravity generated by a " + \
                  "tesseroid model."

    main = Main(name, description, sys.argv, tg.TesseroidGy, version='0.1')
    main.start()
    sys.exit()
