...
"""
TessGz:
    Calculate the Z component of the gravity field of a tesseroid model.
"""
################################################################################
# Created on 5-May-2009 9:05 PM
...
if __name__ == '__main__':
    ...
    name = 'TessGz'
    description = "  Calculates the Z component of gravity generated by a " + \
                  "tesseroid model."

    main = Main(name, description, sys.argv, tg.TesseroidGz, version='0.1')
    main.start()
    sys.exit()
