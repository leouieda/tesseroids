...
/* ************************************ TessGx ********************************************** */
/* ****************************************************************************************** */
/* ***** For calculating the latitudinal <gx> component of gravity of a tesseroid model ***** */
/* ****************************************************************************************** */
...
#include "include/GxCalculator3D.h"
#include "include/GxCalculator2D.h"
...
int main(int argc, char* argv[]){
    ...
    if(argc == 1){        
        cerr << "\n  This is TessGx:";
        cerr << "\n      - Calculate the latitudinal <gx> component of gravity of a tesseroid model\n\n";
        cerr << "\n  Synopsis:\n";
        cerr << "\n   tessgx.exe model_file -R<W/E/S/N> -B<nLon/nLat> -Z<hight> -O<Lon/Lat/R> -A<type>\n\n";
        cerr << "\n  Mandatory arguments:\n";
    ...
    try{
        ...
        if(algorithmType.compare("3D")==0){   
            ...
            field = new GxCalculator3D(latO,lonO,rO);
            /* Status msg */
            fprintf(stderr, "\n\nCalculating field using 3D GLQ...");    
                   
        } else if(algorithmType.compare("2D")==0){    
                   
            field = new GxCalculator2D(latO,lonO);
            /* Status msg */
