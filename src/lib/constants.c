...
accurate */
const double TESSEROID_GXX_SIZE_RATIO = 5.5;
const double TESSEROID_GXY_SIZE_RATIO = 5.5;
const double TESSEROID_GXZ_SIZE_RATIO = 5.5;
const double TESSEROID_GYY_SIZE_RATIO = 5.5;
const double TESSEROID_GYZ_SIZE_RATIO = 5.5;
const double TESSEROID_GZZ_SIZE_RATIO = 5.5;
