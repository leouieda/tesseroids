...
/* ************************************ TessGyz ********************************************* */
/* ****************************************************************************************** */
/* *********** For calculating the Gyz component of the gravity gradient tensor ************* */
...
#include "include/GyzCalculator3D.h"
#include "include/GyzCalculator2D.h"
...
int main(int argc, char* argv[]){
    ...
    if(argc == 1){               
        cerr << "\n  This is TessGyz:";
        cerr << "\n    - Calculate the Gyz component of the gravity gradient tensor of a tesseroid model\n\n";
        cerr << "\n  Synopsis:\n";
        cerr << "\n   tessgyz.exe model_file -R<W/E/S/N> -B<nLon/nLat> -Z<hight> -O<Lon/Lat/R> -A<type>\n\n";
        cerr << "\n  Mandatory arguments:\n";
    ...
    try{
        ...
        if(algorithmType.compare("3D")==0){   
            ...
            field = new GyzCalculator3D(latO,lonO,rO);
            /* Status msg */
            fprintf(stderr, "\n\nCalculating field using 3D GLQ...");    
                   
        } else if(algorithmType.compare("2D")==0){    
                   
            field = new GyzCalculator2D(latO,lonO);
            /* Status msg */
