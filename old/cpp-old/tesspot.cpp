...
/* ************************************ TessPot ********************************************* */
/* ****************************************************************************************** */
/* ************* For calculating the gravity potential in spherical coordinates ************* */
/* ****************************************************************************************** */
...
#include "include/PotentialCalculator3D.h"
#include "include/PotentialCalculator2D.h"
...
int main(int argc, char* argv[]){
    ...
    if(argc == 1){                
        cerr << "\n  This is TessPot:";
        cerr << "\n      - Calculate the spherical gravity potential of a tesseroid model\n\n";
        cerr << "\n  Synopsis:\n";
        cerr << "\n   tesspot.exe model_file -R<W/E/S/N> -B<nLon/nLat> -Z<hight> -O<Lon/Lat/R> -A<type>\n\n";
        cerr << "\n  Mandatory arguments:\n";
    ...
    try{
        ...
        if(algorithmType.compare("3D")==0){   
            ...
            field = new PotentialCalculator3D(latO,lonO,rO);
            /* Status msg */
            fprintf(stderr, "\n\nCalculating field using 3D GLQ...");    
                   
        } else if(algorithmType.compare("2D")==0){    
                   
            field = new PotentialCalculator2D(latO,lonO);
            /* Status msg */
